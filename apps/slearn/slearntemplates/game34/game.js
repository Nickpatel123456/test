...
// IE6 in standards compliant mode (i.e. with a valid doctype as the first line in the document)
    ...
    function lap1Reached() {
        ...
        if (overlap == true) {
            $("#nails").remove();
            $("#me").hide();
            // $("#me,#option3text,#option4text").hide();
            ...
            count = 0;
            sessionStorage.setItem('game34questionId', count);
            $(xml).find('level1').each(function () {
                audioSrc = xml.find("QuestionAudio")[0].firstChild.data;
                totalquestion = xml.find("QuestionText").length;
                $("#questiontext").html("<span onclick='playAudio(audioSrc)'><img id='audioImg0' src='/apps/slearn/slearntemplates/assets/pause.png' width='40'></span><span class='pl-5'> પ્રશ્ન. " + xml.find("QuestionText")[count].firstChild.data + "</span>");
                $("#option1text").html(xml.find("QuestionAudio")[count].nextElementSibling.children[0].firstChild.data);
                $("#option2text").html(xml.find("QuestionAudio")[count].nextElementSibling.children[1].firstChild.data);
                $("#option3text").html(xml.find("QuestionAudio")[count].nextElementSibling.children[2].firstChild.data);
                $("#option4text").html(xml.find("QuestionAudio")[count].nextElementSibling.children[3].firstChild.data);
    ...
    function lap2Reached() {
        ...
        if (overlap == true) {
            ...
            count = 0;
            sessionStorage.setItem('game34questionId', '2');
            $(xml).find('level2').each(function () {
                $("#QuesText").html("<span onclick='playAudio(" + 2 + ")'><img id='audioImg1' src='/apps/slearn/slearntemplates/assets/pause.png' width='40'></span><span class='pl-5'> પ્રશ્ન. " + xml.find("QuestionText")[1].firstChild.data + "</span>");
                question[0] = mat + xml.find("QuestionVideo")[0].firstChild.data;
                $("#questype").html("<video width='100%' controls><source src='" + question[0] + "' type='video/mp4'></video>");
                $("#option1").html(xml.find("QuestionVideo")[count].nextElementSibling.children[0].firstChild.data);
                $("#option2").html(xml.find("QuestionVideo")[count].nextElementSibling.children[1].firstChild.data);
                $("#option3").html(xml.find("QuestionVideo")[count].nextElementSibling.children[2].firstChild.data);
                $("#option4").html(xml.find("QuestionVideo")[count].nextElementSibling.children[3].firstChild.data);
                correctAnswer = xml.find("CorrectAnswerOptionID")[count].firstChild.data;
            });
            hideAudioImg();
        }
    ...
    function lap3Reached() {
        ...
        if (overlap == true) {
            ...
            $(xml).find('level3').each(function () {
                $("#questiontext").html("<span onclick='playAudio(" + 3 + ")'><img id='audioImg2' src='/apps/slearn/slearntemplates/assets/pause.png' width='40'></span><span class='pl-5'> પ્રશ્ન. " + xml.find("QuestionText")[count].firstChild.data + "</span>");
                option1[0] = mat + xml.find("Option1Image")[0].firstChild.data;
                option2[0] = mat + xml.find("Option2Image")[0].firstChild.data;
                option3[0] = mat + xml.find("Option3Image")[0].firstChild.data;
                option4[0] = mat + xml.find("Option4Image")[0].firstChild.data;
                $("#option1text").html("<img src='" + option1[0] + "' style='width:30%;'/>");
                $("#option2text").html("<img src='" + option2[0] + "' style='width:30%'/>");
                $("#option3text").html("<img src='" + option3[0] + "' style='width:30%'/>");
                $("#option4text").html("<img src='" + option4[0] + "' style='width:30%'/>");
                correctAnswer = xml.find("CorrectAnswerOptionID")[count].firstChild.data;
            });
            hideAudioImg();
        }
    ...
    function lap4Reached() {
        ...
        if (overlap == true) {
            ...
            $(xml).find('level4').each(function () {
                $("#QuesText").html("<span onclick='playAudio(" + 4 + ")'><img id='audioImg3' src='/apps/slearn/slearntemplates/assets/pause.png' width='40'></span><span class='pl-5'> પ્રશ્ન. " + xml.find("QuestionText")[count].firstChild.data + "</span>");
                question[0] = mat + xml.find("QuestionImage").text();
                $("#questype").html("<img src='" + question[0] + "' style='width:100%'/>");
                option1[1] = mat + xml.find("Option1Image")[1].firstChild.data;
                option2[1] = mat + xml.find("Option2Image")[1].firstChild.data;
                option3[1] = mat + xml.find("Option3Image")[1].firstChild.data;
                option4[1] = mat + xml.find("Option4Image")[1].firstChild.data;
                $("#option1").html("<img src='" + option1[1] + "' style='width:30%'/>");
                $("#option2").html("<img src='" + option2[1] + "' style='width:30%'/>");
                $("#option3").html("<img src='" + option3[1] + "' style='width:30%'/>");
                $("#option4").html("<img src='" + option4[1] + "' style='width:30%'/>");
                correctAnswer = xml.find("CorrectAnswerOptionID")[count].firstChild.data;
            });
            hideAudioImg();
        }
    ...
    function lap5Reached() {
        ...
        if (overlap == true) {
            ...
            $(xml).find('level5').each(function () {
                audioSrc =  xml.find("QuestionAudio")[1].firstChild.data;
                $("#questiontext").html("<span onclick='playAudio(audioSrc)'><img id='audioImg4' src='/apps/slearn/slearntemplates/assets/pause.png' width='40'></span><span class='pl-5'> પ્રશ્ન. " + xml.find("QuestionText")[count].firstChild.data + "</span>");
                option1[2] = mat + xml.find("Option1Image")[2].firstChild.data;
                option2[2] = mat + xml.find("Option2Image")[2].firstChild.data;
                option3[2] = mat + xml.find("Option3Image")[2].firstChild.data;
                option4[2] = mat + xml.find("Option4Image")[2].firstChild.data;
                $("#option1text").html("<img src='" + option1[2] + "' style='width:30%'/>");
                $("#option2text").html("<img src='" + option2[2] + "' style='width:30%'/>");
                $("#option3text").html("<img src='" + option3[2] + "' style='width:30%'/>");
                $("#option4text").html("<img src='" + option4[2] + "' style='width:30%'/>");
                correctAnswer = xml.find("CorrectAnswerOptionID")[count].firstChild.data;
            });
        }
    }
    ...
    function lap6Reached() {
        ...
        if (overlap == true) {
            ...
            $(xml).find('level6').each(function () {
                $("#QuesText").html("<span onclick='playAudio("+6+")'><img id='audioImg5' src='/apps/slearn/slearntemplates/assets/pause.png' width='40'></span><span class='pl-5'> પ્રશ્ન. " + xml.find("QuestionText")[count].firstChild.data + "</span>");
                question[1] = mat + xml.find("QuestionVideo")[1].firstChild.data;
                $("#questype").html("<video width='100%' controls ><source src='" + question[1] + "' type='video/mp4'></video>");
                option1[3] = mat + xml.find("Option1Image")[3].firstChild.data;
                option2[3] = mat + xml.find("Option2Image")[3].firstChild.data;
                option3[3] = mat + xml.find("Option3Image")[3].firstChild.data;
                option4[3] = mat + xml.find("Option4Image")[3].firstChild.data;
                $("#option1").html("<img src='" + option1[3] + "' style='width:30%'/>");
                $("#option2").html("<img src='" + option2[3] + "' style='width:30%'/>");
                $("#option3").html("<img src='" + option3[3] + "' style='width:30%'/>");
                $("#option4").html("<img src='" + option4[3] + "' style='width:30%'/>");
                correctAnswer = xml.find("CorrectAnswerOptionID")[count].firstChild.data;
            });
            hideAudioImg();
        }
...
function playAudio(quesionNumber) {
    ...
    if (isPlaying) {
        myAudio.pause();
        isPlaying = false;
        $('#audioImg' + sessionStorage.getItem('game34questionId')).attr('src', '/apps/slearn/slearntemplates/assets/pause.png');
    } else {
        myAudio.play();
        $('#audioImg' + sessionStorage.getItem('game34questionId')).attr('src', '/apps/slearn/slearntemplates/assets/play.png');
    }
};
...
function hideAudioImg() {
    if (sessionStorage.getItem('selectedfloor') > 4 || sessionStorage.getItem('activity_standard') > 4) {
        $('#audioImg' + sessionStorage.getItem('game34questionId')).hide();
    }
}
...
function checkAnswer(options) {
    stopQuestionAudio();
    sessionStorage.removeItem("game34questionId");
