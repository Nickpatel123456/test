...
function loadQuestionsToMemory() {
    ...
    $(xml).find('Question').each(function () {
        ...
        option1[count] = mat + xml.find("QuestionAudio")[count].nextElementSibling.children[0].firstChild.data;
        option2[count] = mat + xml.find("QuestionAudio")[count].nextElementSibling.children[1].firstChild.data;
        option3[count] = mat + xml.find("QuestionAudio")[count].nextElementSibling.children[2].firstChild.data;
        option4[count] = mat + xml.find("QuestionAudio")[count].nextElementSibling.children[3].firstChild.data;
        option5[count] = xml.find("QuestionAudio")[count].nextElementSibling.children[4].firstChild.data;
        option6[count] = xml.find("QuestionAudio")[count].nextElementSibling.children[5].firstChild.data;
        option7[count] = xml.find("QuestionAudio")[count].nextElementSibling.children[6].firstChild.data;
        option8[count] = xml.find("QuestionAudio")[count].nextElementSibling.children[7].firstChild.data;
...
function displayQuestions(count) {
    if ((currentquestionnumber + 1) > question.length) {
        ...
        var optionArray = [];
        optionArray = [
            {optionid: 1, optionvalue: option5[shuffledQuestionNumber[count]]},
            {optionid: 2, optionvalue: option6[shuffledQuestionNumber[count]]},
            {optionid: 3, optionvalue: option7[shuffledQuestionNumber[count]]},
            {optionid: 4, optionvalue: option8[shuffledQuestionNumber[count]]}
        ];
        ...
        $("#questiontext").html("<span onclick='togglePlay(audioSrc)'><img id='audioImg' src='/apps/slearn/slearntemplates/assets/pause.png' width='40'></span><span class='pl-5'> [" + (currentquestionnumber + 1) + "] " + question1[shuffledQuestionNumber[count]] + "</span>");
