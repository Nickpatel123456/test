        ...
        if (quesid == 1 || quesid == 2 || quesid == 3) {
            ...
            if (selectOptionValueMatch != 1) {
                ...
                if (flag == 0) {
                    ...
                    $("#div" + quesid).append("<h4 align='center' class='wrongAnswer'>" + tdText + "</h4>");
                    ...
                    $("#div" + quesid).append("<h4 align='center' class='rightAnswer'>" + tdText + "</h4>");
                    var elem = document.getElementById(tdId);
                    // elem.style.display = "none";
                    cnt++;
                }

                if (cnt == len || cnt == (len * 2) || cnt == (len * 3)) {
                    stopQuestionAudio();
