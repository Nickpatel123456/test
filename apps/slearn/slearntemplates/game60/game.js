...
function ShowVideo() {
    console.log("Went inside show video");
    ...
    document.getElementById('myviddd').addEventListener('ended', showquestionsandoptionsbtnaftervideocompleted, false);

    function showquestionsandoptionsbtnaftervideocompleted() {
        $('#quesVid').hide();
        $('#questiontext').show();
        $('#optiontext').show();
        $('#checkanswerbtn').show();
...
function startGame() {
    console.log("Went insideo start game");
...
function displayQuestions(count) {
    console.log("went inside displayquestions");
