...
function displayQuestions(count) {
    if ((currentquestionnumber + 1) > questiontext.length) {
        ...
        for (var j = 0; j < optionArray.length; j++) {
            ...
            // $("#option"+(j+1)+"image").html("<input type='radio' name='optradio' class='radioButton' id='option' value='"+optionArray[mcqshuffledquestionnumber[j]].optionid+"'>&nbsp;&nbsp;<img src='" + optionArray[mcqshuffledquestionnumber[j]].optionvalue + "' style='width:50%;height:50%'/>");
        }
