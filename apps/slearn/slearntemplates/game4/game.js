...
function loadQuestionsToMemory() {
    ...
    $(xml).find('Question').each(function () {
        ...
        option1[count] = xml.find("QuestionVideo")[count].nextElementSibling.children[0].firstChild.data;
        option2[count] = xml.find("QuestionVideo")[count].nextElementSibling.children[1].firstChild.data;
        option3[count] = xml.find("QuestionVideo")[count].nextElementSibling.children[2].firstChild.data;
        option4[count] = xml.find("QuestionVideo")[count].nextElementSibling.children[3].firstChild.data;
...
function checkGameStatus() {
    ...
    if (((selected_floor < (current_floor - 3)) && percentage_correct >= 90) || ((selected_floor >= (current_floor - 3)) && percentage_correct >= 80)) {
        ...
        if (sessionStorage.clickcount == 1 && anchor == "Yes") {
            ...
            ConsultToTeacher(); //call the logic common anchor js file
        } else {
