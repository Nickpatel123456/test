...
function LoadFrontImage() {
    ...
    for (i = 1; i <= rowByColumn * rowByColumn; i++) {
    ...
    var counter = 0;
    for (var i = 0; i < rowByColumn; ++i) {
        var tr = $("<tr></tr>");
        $game_table1.append(tr);
        for (var j = 0; j < rowByColumn; ++j) {
            var frontImageUrl = mat + "images/" + storeImageName[counter] + '.jpg';
            tr.append("<td align='center'><img src='" + frontImageUrl + "' class='img-thumbnail img-responsive' width='125' height='125'></td>");
            counter++;
        }
    }
}
...
function BackImageLoad() {
    ...
    for (var i = 0; i < rowByColumn; ++i) {
        ...
        for (var j = 0; j < rowByColumn; ++j) {
            ...
            tr.append("<td align='center'><img src='" + backImageUrl + "' id='" + counter + "' width='125' height='125'></td>");
            counter++;
        }
    }
...
function checkUserSelectImageMatchOrNot() {
    ...
    if (imagematchcounter == (rowByColumn * rowByColumn) / 2) {
