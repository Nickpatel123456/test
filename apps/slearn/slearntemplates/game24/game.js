...
function loadQuestionsToMemory() {
    ...
    $(xml).find('Question').each(function () {
        ...
        option3[count] = xml.find("QuestionAudio")[count].nextElementSibling.children[2].firstChild.data;
        option4[count] = xml.find("QuestionAudio")[count].nextElementSibling.children[3].firstChild.data;
