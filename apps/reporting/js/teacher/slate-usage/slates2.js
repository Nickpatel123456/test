...
.controller('TeacherSlate2ReportController',function ($scope, ajaxCallsFactory, FromdateTodateFactory, dashboardServices, dataModalServices, barchartcolorServices, convertHourServices) {
			...
			.then(function (response2){	
				...
				function subjectwiseusageRecursive(start,end){
					...
					.then(function (response1){	
						var teachersubjectusagedata = response1.data.data;
						
						if(teachersubjectusagedata[subject_id]){
							var hourconvert = convertHourServices.convertDurationToHour(teachersubjectusagedata[subject_id].duration);
