...
.controller('Slearn10ReportController',function ($scope, ajaxCallsFactory, FromdateTodateFactory, dashboardServices, dataModalServices, barchartcolorServices, convertHourServices) {
	...
	$scope.loadreportusage1report = function(){
		...
		$.ajax({
			type: "POST",
			url: skiilreport_backend_api + 'teacher/reportusage',
			data:objdata,
			headers: { 
