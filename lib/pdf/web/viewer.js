...
'use strict';
  ...
  var pdfurlpath = baseurl[0] + "//" + baseurl[2];
  var pdf_name = baseurl[6].split("pdfname=");
  if(sessionStorage.getItem("slquizreport") == "yes"){
	  var DEFAULT_URL = pdfurlpath + "/year_report_pdf/"+pdf_name[1];
  }else{
	  var DEFAULT_URL = pdfurlpath + "/usermanual_pdf/"+pdf_name[1];
  }
...
function validateFileURL(file) {
  try {
	...
	/*this line in comment match the diff url 
